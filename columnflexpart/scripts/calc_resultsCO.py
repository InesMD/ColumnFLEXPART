...
if __name__ == '__main__':
    ...
    for dir in tqdm(files):
        if not "trajectories.pkl" in os.listdir(dir):
            ...
            continue     
        try: 
            fd = FlexDatasetCO(dir, ct_dir=args.conc_dir, ct_name_dummy=args.conc_name, chunks=dict(time=20, pointspec=4))
            ...
            tr.co_from_endpoints(boundary=args.boundary)
            tr.save_endpoints()
            ...
            xco2_measurement = float(fd.measurement.data.xco)
