...
class FlexDatasetCO:    
    ...
    def pressure_weights_from_height(self,): 
        pressures_low = self.pressure_factor(  self.release["boundary_low"], self.release["lon"], self.release["lat"] ) 
        pressures_up = self.pressure_factor(  self.release["boundary_up"], self.release["lon"], self.release["lat"]  )
